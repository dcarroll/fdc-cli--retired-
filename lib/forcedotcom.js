...
var doLogin = function(un, pw) {
	...
	//	if (err) { return onErr(err); }
		...
		//sforce.connection.serverUrl = "https://https://login-dooder-developer-edition.na1-blitz04.t.force.com/services/Soap/u/29.0";
		...
		if (typeof lr === 'array') {
			...
			commandLineUtils.processArgsInteractive([], argProcessorList, function (outputArgsMap) {
    			...
    			writeFile(CREDS, { app:{ name:app["sf:Name"], id:app["sf:Id"][0] }, lr:lr });
    		});
		}
	//}); 
}
